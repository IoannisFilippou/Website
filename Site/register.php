...
<div id="page">
	...
	<form name = "myform" method="post" action="register_connection.php">
		<fieldset>
		<legend>Register information </legend><br></br>
		
		<label for="name">Name: </label>
		<input type="text" id="name" name="name" required="required" /> <br><br/>
		
		<label for="surname">Surname: </label>
		<input type="text" id="surname" name="surname" required="required"/> <br><br/>
		
		<label for="password">Password: </label>
		<input type="password" id="password" name="password" required="required"/><br> <br/>
		
		<label for="country">Country: </label>
		<input type="text" id="country" name="country" required="required"/> <br><br/>
		
		<label for="age">Age: </label>
		<input type="number" min="1" max="100" id="age" name="age" required="required"/><br> <br/>
		...
		<INPUT TYPE="BUTTON" VALUE="Home Page" ONCLICK="index.php">
		</fieldset>
	</form>
